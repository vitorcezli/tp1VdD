 ...
 */
var quantidadeLinhaImpressao = 7;
...
/**
 * inicializa a tabela. Esta função deve ser invocada na inicialização
 * da página.
 */
...
/**
 * atualiza a tabela quando NEXT é pressionado
 */
function avaliaBotaoNext() {
	if( primeiraLinhaImpressao + quantidadeLinhaImpressao < 
...
/**
 * atualiza a tabela quando PREVIOUS é pressionado
 */
function avaliaBotaoPrevious() {
	if( primeiraLinhaImpressao - quantidadeLinhaImpressao < 0 ) {
		primeiraLinhaImpressao = 0;
	} else {
		primeiraLinhaImpressao -= quantidadeLinhaImpressao;
	}
